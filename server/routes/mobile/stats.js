...
router.post("/read", (req, res) => {
  ...
  console.log(
    "클라이언트 조회 요청 경로 : /mobile/stats/read \n요청 데이터 : "
  );
...
router.post("/vending/read", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 조회 요청 경로 : /mobile/stats/vending/read \n요청 데이터 : "
  );
  console.log(req.body);
    ...
    db.query(
      ...
      (err, results2) => {
        ...
        if (err) {
          ...
          // 데이터 삽입
          for (let result of results2) {
            response.vendings[result.vending_name].saleDate.push(
              result.sale_date
            );
...
router.post("/drink/read", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 조회 요청 경로 : /mobile/stats/drink/read \n요청 데이터 : "
  );
  console.log(req.body);
