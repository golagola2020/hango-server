...
router.post("/read", (req, res) => {
  ...
  console.log(
    "클라이언트 조회 요청 경로 : /admin/user/read \n요청 데이터 없음"
  );
...
router.post("/search", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 검색 요청 경로 : /admin/user/search \n요청 데이터 : "
  );
  ...
  if (!String.isEmpty(req.body)) {
    db.query(
      `SELECT user_id, user_name, user_email, date_format(user_in_date, '%Y년 %m월 %d일 %H시 %i분 %s초') AS date 
        FROM users ${query}`,
      (err, results) => {
        if (err) {
...
router.post("/:userId", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 조회 요청 경로 : /admin/user/:userId \n요청 데이터 : "
  );
  console.log(userId);
...
router.get("/:userId/update", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 조회 요청 경로 : /admin/user/:userId/update \n요청 데이터 : "
  );
  console.log(userId);
...
router.put("/:userId/update", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 수정 요청 경로 : /admin/user/:userId/update \n요청 데이터 : "
  );
  console.log(req.body);
...
router.delete("/:userId", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 삭제 요청 경로 : /admin/user/:userId \n요청 데이터 : "
  );
  console.log(userId);
