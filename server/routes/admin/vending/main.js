...
router.post("/read", (req, res) => {
  ...
  console.log(
    "클라이언트 조회 요청 경로 : /admin/vending/read \n요청 데이터 없음"
  );
...
router.post("/search", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 검색 요청 경로 : /admin/vending/search \n요청 데이터 : "
  );
...
router.post("/:serialNumber", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 조회 요청 경로 : /admin/vending/:serialNumber \n요청 데이터 : "
  );
...
router.get("/:serialNumber/update", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 조회 요청 경로 : /admin/vending/:serialNumber/update \n요청 데이터 : "
  );
  console.log(serialNumber);
...
router.put("/:serialNumber/update", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 수정 요청 경로 : /admin/vending/:serialNumber/update \n요청 데이터 : "
  );
  console.log(req.body);
...
router.delete("/:serialNumber", (req, res) => {
  ...
  // 클라이언트의 요청 데이터를 터미널에 출력
  console.log(
    "클라이언트 삭제 요청 경로 : /admin/vending/:serialNumber \n요청 데이터 : "
  );
  console.log(serialNumber);
