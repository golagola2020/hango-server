        ...
        db.query(`SELECT serial_number, vending_name, vending_description, vending_full_size 
            ...
            [serialNumber], (err, vendings) => {
                ...
                const response = {
                    success : true,
                    vending : {
                        serialNumber : vendings[0].serialNumber,
                        name : vendings[0].vending_name,
                        description : vendings[0].vending_description,
                        fullSize : vendings[0].vending_full_size
                    },
                    drinks : [],
                };

                // 음료 정보 조회
                db.query(`SELECT drink_position, drink_name, exist_flag, drink_count 
                    FROM drinks WHERE serial_number = ?;`, 
