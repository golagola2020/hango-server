...
router.post('/create', (req, res) => {
  ...
  if (!String.isEmpty(serialNumber)) {
    ...
    db.query(
      ...
      [serialNumber, drink.position, drink.name, drink.price, drink.maxCount, drink.maxCount],
      (err) => {
        if (err) {
          // 실패시 false 응답
          response.success = false;
...
router.post('/update', (req, res) => {
  ...
  if (!String.isEmpty(serialNumber)) {
    ...
    db.query(
      ...
      [drink.name, drink.price, drink.maxCount, drink.maxCount, serialNumber, drink.position],
      (err) => {
        if (err) {
          // 실패시 false 응답
          response.success = false;
